document.getElementById('signupForm').addEventListener('submit', function(e) {
    ...
    if (isValid) {
        ...
        fetch('https://content-corner-8vf4.onrender.com/api/signup', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    showSuccessModal('Sign up successful!', data.message);
                } else {
...
// Real-time error clearing for signup form fields
document.getElementById('email').addEventListener('input', function() {
    clearFieldError(this, document.getElementById('emailError'));
});
document.getElementById('username').addEventListener('input', function() {
    clearFieldError(this, document.getElementById('usernameError'));
});
